<template>
  <div class="header bg-background" min-h-50px>
    <RadioGroupRoot v-model="theme" class="flex flex-col gap-2.5" default-value="default" aria-label="View density">
      <div class="flex items-center">
        ...
        <label class="text-stone-700 dark:text-white text-sm leading-none pl-[15px]" for="r1">Default</label>
      </div>
      <div class="flex items-center">
        <RadioGroupItem
          id="r2"
        ...
        <label class="text-stone-700 dark:text-white text-sm leading-none pl-[15px]" for="r2">Comfortable</label>
      </div>
      <div class="flex items-center">
        <RadioGroupItem
          id="r3"
        ...
        <label class="text-stone-700 dark:text-white text-sm leading-none pl-[15px]" for="r3">Compact</label>
      </div>
    </RadioGroupRoot>
  </div>
</template>
